...
score one two = 
    if ((one == "A") && (two == "X")) then 3 + 0
    else if (one == "A") && (two == "Y") then 1 + 3
    else if (one == "A") && (two == "Z") then 2 + 6
    else if (one == "B") && (two == "X") then 1 + 0
    else if (one == "B") && (two == "Y") then 2 + 3
    else if (one == "B") && (two == "Z") then 3 + 6
    else if (one == "C") && (two == "X") then 2 + 0
    else if (one == "C") && (two == "Y") then 3 + 3
    else if (one == "C") && (two == "Z") then 1 + 6
    else 0
